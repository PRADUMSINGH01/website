    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6 mt-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* About Us */}
          <div>
            <h3 className="text-xl font-bold mb-4">Parts Point</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">12, Near Auto point  Jaipur Ind . </span>
              </li>
              <li className="flex items-center">
                <FaPhone className="mr-3" />
                <span className="text-gray-400">+91 459-5123-4567</span>
              </li>
              <li className="flex items-center">
